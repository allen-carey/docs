---
title: 'How to Execute Mobile Tests'
description: 'Learn how to execute Mobile Tests'
'og:title': 'How to Execute Mobile Tests | Endtest'
'og:description': 'Learn how to execute Mobile Tests'
'og:site_name': 'Endtest'
'og:image': 'https://app.endtest.io/images/endtest_black_logo_og.png'
'twitter:title': 'How to execute Mobile Tests | Endtest'
'twitter:description': 'Learn how to execute Mobile Tests'
---
...
>
  <source type="video/mp4" src="https://endtest-videos.s3-us-west-2.amazonaws.com/documentation/endtest_browserstack.mp4" />
</video>
...
11. Click on the `Run` button and select `BrowserStack` from the `Grid` dropdown.
12. Select the desired configuration.
13. Paste the `File Download URL` in the `APK Download URL` / `IPA Download URL` input.
14. Start the test execution.
    
<video
  controls
  className="w-full aspect-video"
>
  <source type="video/mp4" src="https://endtest-videos.s3-us-west-2.amazonaws.com/documentation/endtest_execute_mobile_test_on_browserstack.mp4" />
</video>
...
10. Go to the [Mobile Tests](https://app.endtest.io/mobile-tests) section in Endtest.
11. Click on the `Run` button next to your test suite and select `Sauce Labs` from the `Grid` dropdown.
12. Select the desired configuration.
13. Paste the `File Download URL` in the `APK Download URL` / `IPA Download URL` input.
14. Start the test execution.
