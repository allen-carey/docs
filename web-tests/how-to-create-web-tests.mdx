...
icon: 'plus'
'og:title': 'How to Create Web Tests | Endtest'
'og:description': 'Learn how to record or manually create Web Tests'
'og:image': 'https://app.endtest.io/images/endtest_black_logo_og.png'
'og:site_name': 'Endtest'
'twitter:title': 'How to create Web Tests | Endtest'
'twitter:description': 'Learn how to record or manually create Web Tests'
---
